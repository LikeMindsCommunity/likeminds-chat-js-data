...
import { IQueryParams } from 'src/shared/models/query-params';
...
export class BaseService {
    ...
    buildHttpHeaders(headers: Object): HttpHeaders {
        ...
        for (const key in headers) if (headers.hasOwnProperty(key) && headers[key]) params = params.append(key, headers[key].toString());
        return params;
    }
}
